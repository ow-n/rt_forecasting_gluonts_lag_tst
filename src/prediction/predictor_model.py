...
class Forecaster:
    """A wrapper class for the LagTST Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "LagTST Forecaster"
    ...
    def __init__(
        ...
        """Construct a new LagTST Forecaster
        ...
        Args:
            ...
            d_model (int): Size of hidden layers in the Transformer encoder.

            nhead (int): Number of attention heads in the Transformer encoder which must divide d_model.

            dim_feedforward (int): Size of hidden layers in the Transformer encoder.
            ...
            norm_first (int): Whether to apply normalization before or after the attention.

            num_encoder_layers (int): Number of layers in the Transformer encoder.

            activation (str): Activation function in the Transformer encoder.
    ...
    def fit(
        ...
        A separate LagTST model is fit to each series that is contained
        in the data.
